...
class SoftwarePermissions(TestCase):
    ...
    def test_software_auth_view_user_anon_denied(self):
        ...
        client = Client()
        url = reverse('ITAM:_software_view', kwargs={'pk': self.item.id})
    ...
    def test_software_auth_add_user_anon_denied(self):
        ...
        client = Client()
        url = reverse('ITAM:_software_add')
    ...
    def test_software_auth_add_has_permission(self):
        ...
        response = client.post(url, data={'software': 'software', 'organization': self.organization.id})
    ...
    def test_software_auth_delete_user_anon_denied(self):
        ...
        client = Client()
        url = reverse('ITAM:_software_delete', kwargs={'pk': self.item.id})
    ...
    def test_software_auth_delete_has_permission(self):
        ...
        assert response.status_code == 302 and response.url == reverse('ITAM:Software')
