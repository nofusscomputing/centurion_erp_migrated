...
class SlashCommands:
    ...
    def setUpTestData(self):
        ...
        self.single_command_multiple_item = TicketComment.objects.create(
            ticket = self.ticket,
            comment_type = TicketComment.CommentType.COMMENT,
            body = "random text\r\n" + self.command_single_command_multiple_item + "\r\n"
        )
        ...
        self.multiple_command_single_item = TicketComment.objects.create(
            ticket = self.ticket,
            comment_type = TicketComment.CommentType.COMMENT,
            body = "random text\r\n" + self.command_multiple_command_single_item + "\r\n"
        )
    ...
    def test_slash_command_comment_single_command_multiple_item_comment_command_removed(self):
        ...
        assert '/' + self.slash_command not in self.single_command_multiple_item.body
    ...
    def test_slash_command_comment_multiple_command_single_item_comment_command_removed(self):
        ...
        assert '/' + self.slash_command not in self.multiple_command_single_item.body
...
class RelatedItemSlashCommand(
    ...
    def test_slash_command_comment_single_command_multiple_item_comment_item_removed(self):
        ...
        assert (
            self.item_two not in self.single_command_multiple_item.body
            and self.item_three not in self.single_command_multiple_item.body
        )
    ...
    def test_slash_command_comment_multiple_command_single_item_comment_item_removed(self):
        ...
        assert (
            self.item_four not in self.multiple_command_single_item.body
            and self.item_five not in self.multiple_command_single_item.body
        )
