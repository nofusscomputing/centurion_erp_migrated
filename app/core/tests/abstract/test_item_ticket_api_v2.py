...
class ItemTicketAPI(
    ...
    """Common Test Cases for Linked Ticket Items

    This class must be inherited by all test classes by item type.
    ...
    def setUpTestData(self):
        ...
        This setup method must be called from inheriting class with `super`
